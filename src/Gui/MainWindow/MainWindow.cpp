...
const char COMMUNITY_FORUM_URL[] = "https://discordapp.com/invite/36a3RrG";
const char REPORT_ISSUE_URL[] = "https://geem.io/contact";

const char DONATION_URL_DONATION_TAG[] = "donation";
const char DONATION_URL_LABEL_TAG[] = "label";
const char DONATION_ADDRESS[] = "G95DwiVGzrbPBAYZRaebH2Y5T5nwDvL4wRJo1xcrHynHAv7zqp39WGNaFCX6JeRyKk823aaF6bkN21MR62888rywVatVMGE";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Geem Wallet %1").arg(Settings::instance().getVersion()));
