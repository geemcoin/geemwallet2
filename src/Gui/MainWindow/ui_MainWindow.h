...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/Geem"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutGeemAction = new QAction(MainWindow);
        m_aboutGeemAction->setObjectName(QStringLiteral("m_aboutGeemAction"));
        m_aboutGeemAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutGeemAction);
        ...
        QObject::connect(m_aboutGeemAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
...
#endif // QT_NO_TOOLTIP
        m_aboutGeemAction->setText(QApplication::translate("MainWindow", "About Geem Wallet", nullptr));
