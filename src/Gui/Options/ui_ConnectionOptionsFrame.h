...
public:
    ...
    void retranslateUi(QFrame *ConnectionOptionsFrame)
    {
        ...
        m_autoHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local Geem daemon process on port 32348. In case of no local daemon running it will use an in-wallet embedded node implementation.", nullptr));
        m_embeddedRadio->setText(QApplication::translate("ConnectionOptionsFrame", "Embedded", nullptr));
        m_embeddedHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "An in-wallet embedded Geem node will be used.", nullptr));
        ...
        m_localHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local Geem daemon process. Please specify daemon's port.", nullptr));
        ...
        m_remoteHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to Geem node running on another PC in the local or global network. Please specify IP address or domain name and the port. If masternode is specified additional fee 0.25% but no more than 1 GEEM is applied when sending transaction.", nullptr));
    } // retranslateUi
